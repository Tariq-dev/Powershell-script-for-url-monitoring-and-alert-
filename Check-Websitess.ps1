...
If ($alert) {
    $to = "farhan.ali@tenpearls.com","abdul.moiz@tenpearls.com","kashif.siddiqui@tenpearls.com"
...
<table width='100%'>
	...
	<font face='Arial' color='#557799' size='4'><strong> **Coca-Cola Infrastructure:PKI Support(CA-PKI-HSM) Monitoring Report** </strong></font>
	</td>
	</tr>
	</table>
